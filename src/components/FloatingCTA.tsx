      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            <span className="absolute right-full mr-4 bg-black/80 text-white text-xs px-3 py-1.5 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap backdrop-blur-sm pointer-events-none">
              Chat on WhatsApp
            </span>
          </a>
          ...
          <button
            ...
            className="group relative flex items-center justify-center w-14 h-14 bg-[#a4789c] rounded-full text-white shadow-lg shadow-black/20 hover:scale-110 transition-transform duration-300 border-none outline-none cursor-pointer"
          >
            <MessageCircle size={24} />
            <span className="absolute right-full mr-4 bg-black/80 text-white text-xs px-3 py-1.5 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap backdrop-blur-sm pointer-events-none">
              Enquire Now
